public class examen {
    ...
    /**
     * Coge un String va convirtiendo cada caracter a número y lo va concatenando en una variable que es la que luego devuelve.
     * @param numeroString
     * @return
     */
    ...
    /**
     * Introduciendo una cadena, posicion principio y posición final forma una cadena nueva con el sector que elijamos. 
     * @param cadena
     * @param posicion1
     * @param posicion2
     * @return
    ...
    /**
     * Si detecta un número en la cadena estrae los siguientes 4 número incluyendo el que haya detectado
     * @param codigo
     * @return
     */
    ...
    /**
     * Introduce una cadena y te detecta si todas las letras son mayúsculas, si no lo son devuelve false.
     * @param cadena
     * @return
     */
    ...
    /**
     * Devuelve true si el código tiene exactamente 9 caracteres con el formato LLLNNNNNC (3 mayúsculas + 5 dígitos + 1 dígito)
     * @param codigo
     * @return
     */
    ...
    /**
     * Esta función coge un carácter y según el valor de su código ASCII lo resta a 64 porque 65 es el mínimo (65 = 'A') y devuelve un número de 1 a 26
    ...
    /**
     * Suma según la cadena que le introduzcas cada valor de cada carácter teniendo de referencia que A es 1 y Z es 26
    ...
    /**
     * Suma únicamente 5 dígitos, coge un número y suma el primero, con el segundo, este con el tercero....
